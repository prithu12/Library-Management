...
const StudentSidebar = () => {
  const navLinkClass=({isActive})=> `flex items-center gap-3 rounded-lg px-4 py-3 text-sm font-medium transition ${
      isActive
        ? "bg-white text-black"
  ...
  return (
    <aside className="w-[260px] bg-black text-white px-4 py-6 hidden md:block">
           ...
           <div className="mb-8 border-b border-white/10 pb-4">
            ...
            <p className="text-sm text-white/70">Student Panel</p>
           </div>
